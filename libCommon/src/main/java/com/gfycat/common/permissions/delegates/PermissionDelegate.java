...
public abstract class PermissionDelegate<T> {
    private T target;

    PermissionDelegate(T target) {
        this.target = target;
    }
    ...
    public abstract void requestPermission(@NonNull String[] permissions, int requestCode);
