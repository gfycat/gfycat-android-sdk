...
public class IMMLeaks {
    ...
    static class ReferenceCleaner implements MessageQueue.IdleHandler, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalFocusChangeListener {
        ...
        private void clearInputMethodManagerLeak() {
            try {
                ...
                Logging.e("IMMLeaks", "Unexpected reflection exception", unexpected);
     ...
     */
    public static void fixFocusedViewLeak(Application app) {
        ...
        final InputMethodManager inputMethodManager = (InputMethodManager) app.getSystemService(INPUT_METHOD_SERVICE);
        ...
        app.registerActivityLifecycleCallbacks(new LifecycleCallbacksAdapter() {
            @Override
