...
public class TextCategoryViewHolder extends CategoryViewHolder {
    ...
    public TextCategoryViewHolder(TextCategoryView itemView, float aspectRatio, int orientation, float cornerRadius) {
        super(itemView, aspectRatio, orientation, cornerRadius);
    }

    public void bind(GfycatCategory categoryData) {
        super.bind(categoryData);
        ((TextCategoryView) categoryView).getTitleView().setText(categoryData.getTagText());
    }
}
