...
public class IconCategoryView extends CategoryView {
    ...
    public IconCategoryView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IconCategoryView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void sharedConstructor(AttributeSet attrs) {
        ...
        icon = (ImageView) findViewById(R.id.cell_icon);
    }
}