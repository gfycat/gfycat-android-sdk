...
public class NSFWContentManagerAsyncWrapper implements NSFWContentManager {
    ...
    public Runnable reportItem(Gfycat gfycat) {
        return nsfwContentManager != null ? nsfwContentManager.reportItem(gfycat) : null;
    }

    @Override
    public Runnable reportUser(Gfycat gfycat, long undoPossibilityTimeMs) {
        return nsfwContentManager != null ? nsfwContentManager.reportUser(gfycat, undoPossibilityTimeMs) : null;
    }
}
